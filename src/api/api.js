...
export const submitHappinessRating = "/employee/attendance/happiness-rating";
...
export const getUnapprovedAbsentReport = (fromDate, toDate) => 
  `/admin/leave/unapproved-absent?from_date=${fromDate}&to_date=${toDate}`;
